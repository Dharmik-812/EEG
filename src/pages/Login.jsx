...
export default function Login() {
  ...
  return (
    ...
    <section className="min-h-[calc(100vh-6rem)] grid grid-cols-1 lg:grid-cols-2 gap-8 items-center relative">
      ...
      >
        <Card>
          <div className="flex items-center gap-3 text-2xl font-extrabold bg-gradient-to-r from-emerald-600 to-teal-600 bg-clip-text text-transparent">
            <div className="relative">
              <Sparkles className="text-emerald-500 animate-pulse"/> 
              <div className="absolute -top-1 -right-1 w-2 h-2 bg-yellow-400 rounded-full animate-ping"></div>
            </div>
            Welcome Back to AverSoltix
          </div>
          ...
          <div className="mt-6 space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-sm">
              ...
              >
                <TreePine className="h-5 w-5 text-purple-500 flex-shrink-0"/>
      ...
      >
        <Card>
          <div className="text-center mb-6">
            <h2 className="text-2xl font-bold bg-gradient-to-r from-emerald-600 to-teal-600 bg-clip-text text-transparent">Welcome Back</h2>
            <p className="text-slate-600 dark:text-slate-400 mt-2">Sign in to your eco-learning adventure</p>
          </div>
          ...
          <form onSubmit={onSubmit} className="space-y-4">
            ...
            <motion.button 
              ...
              whileTap={{ scale: 0.98 }} 
              className="w-full bg-gradient-to-r from-emerald-500 to-teal-500 hover:from-emerald-600 hover:to-teal-600 text-white font-semibold py-3 px-6 rounded-lg transition-all duration-200 shadow-lg" 
              type="submit"
            >
