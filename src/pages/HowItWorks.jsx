      ...
      <section className="space-y-6">
                ...
                <div className="flex items-center gap-2 mt-4">
                  <div className="flex gap-1">
                    {[...Array(6)].map((_, idx) => (
                      <div
                        key={idx}
                        className={`h-1.5 w-4 rounded-full transition-all duration-300 ${idx <= i ? 'bg-emerald-400' : 'bg-slate-200 dark:bg-slate-700'
                          }`}
                      />
                    ))}
                  </div>
        ...
        <Card>
          ...
          <ol className="list-decimal list-inside space-y-1 text-sm text-slate-700 dark:text-slate-300">
            ...
            <li>Try community quizzes under <Link to="/community" className="text-emerald-600">Community</Link>.</li>
